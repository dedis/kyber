...
func NewBlakeSHA256QR512() *QrSuite {
	//nolint:lll
	p, _ := new(compatible.Int).SetString("10198267722357351868598076141027380280417188309231803909918464305012113541414604537422741096561285049775792035177041672305646773132014126091142862443826263", 10)
	//nolint:lll
	q, _ := new(compatible.Int).SetString("5099133861178675934299038070513690140208594154615901954959232152506056770707302268711370548280642524887896017588520836152823386566007063045571431221913131", 10)
	r := new(compatible.Int).SetUint64(2)
	g := new(compatible.Int).SetUint64(4)
