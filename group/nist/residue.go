...
func (p *residuePoint) Set(p2 crypto.Point) crypto.Point {
	p.g = p2.(*residuePoint).g
	p.Int = p2.(*residuePoint).Int
	return p
}

func (p *residuePoint) Clone() crypto.Point {
...
func (p *residuePoint) Mul(b crypto.Point, s crypto.Scalar) crypto.Point {
	if b == nil {
...
func (g *ResidueGroup) Scalar() crypto.Scalar {
