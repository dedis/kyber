...
var minus_one = new(scalar).SetBytes([]byte{0xec, 0xd3, 0xf5, 0x5c, 0x1a, 0x63, 0x12, 0x58, 0xd6, 0x9c, 0xf7, 0xa2, 0xde, 0xf9, 0xde, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10}).(*scalar)
...
func (s *SimpleCTScalar) Sub(s1, s2 kyber.Scalar) kyber.Scalar {
	...
	// a * b + c = -1 * a + c
	scMulAdd(&s.v, &minus_one.v, &sc1.v, &sc2.v)
	return s
