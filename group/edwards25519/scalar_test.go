...
// Test whether scalar s is in the range 0<=s<L
func TestSc25519IsCanonical(t *testing.T) {
	/* l + 1 = 2^252+27742317777372353535851937790883648493 + 1 */
	var Lplus1 []byte = []byte{0xee, 0xd3, 0xf5, 0x5c, 0x1a, 0x63, 0x12, 0x58, 0xd6,
		0x9c, 0xf7, 0xa2, 0xde, 0xf9, 0xde, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	var L []byte = []byte{0xed, 0xd3, 0xf5, 0x5c, 0x1a, 0x63, 0x12, 0x58, 0xd6,
		0x9c, 0xf7, 0xa2, 0xde, 0xf9, 0xde, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10}
	/* l - 1 = 2^252+27742317777372353535851937790883648493 - 1 */
	var Lminus1 []byte = []byte{0xec, 0xd3, 0xf5, 0x5c, 0x1a, 0x63, 0x12, 0x58, 0xd6,
		0x9c, 0xf7, 0xa2, 0xde, 0xf9, 0xde, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10}

	if Sc25519IsCanonical(Lplus1) != 0 {
		t.Fatalf("l+1 cannot be canonical")
	}
	if Sc25519IsCanonical(L) != 0 {
		t.Fatalf("l cannot be canonical")
	}
	if Sc25519IsCanonical(Lminus1) != 1 {
