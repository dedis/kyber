...
// Encoding represents an crypto.interface to an encoding/decoding
...
// appropriate for a given crypto.Suite.
...
type BinaryEncoding struct {
	Constructor // Constructor for instantiating crypto.types
