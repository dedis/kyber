...
func priXCoords() []abstract.Scalar {
...
func RecoverSecret(shares []PriShare, t int) abstract.Scalar {
...
// xCoords creates an array of x-coordinates for Lagrange interpolation. In the
// returned array, exactly t x-coordinates are non-nil.
func pubXCoords() []abstract.Scalar {
	// XXX: check if it's possible to merge with priXCoords
	return nil
}

// RecoverCommit reconstructs the secret commitment p(0) using Lagrange interpolation.
func RecoverCommit(shares []PubShare, t int) abstract.Point {
