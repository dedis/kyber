...
# The Cothority Network Library - CoNet

The Cothority-network (CoNet) is a library for simulation and deployment of
...
deploy those protocols as a service in a distributed manner. A third part of the
library is used to write applications that contact the services on remote servers.

CoNet is developed by [DEDIS/EFPL](http://dedis.epfl.ch) as part of the
