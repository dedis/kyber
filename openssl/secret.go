...
func (s *secret) Add(x, y abstract.Scalar) abstract.Scalar {
	xs := x.(*secret)
	ys := y.(*secret)
...
func (s *secret) Sub(x, y abstract.Scalar) abstract.Scalar {
	xs := x.(*secret)
	ys := y.(*secret)
...
func (s *secret) Mul(x, y abstract.Scalar) abstract.Scalar {
	xs := x.(*secret)
	ys := y.(*secret)
...
func (s *secret) Div(x, y abstract.Scalar) abstract.Scalar {
	xs := x.(*secret)
	ys := y.(*secret)
