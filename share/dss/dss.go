...
func NewDSS(suite Suite, rand cipher.Stream, secret kyber.Scalar, participants []kyber.Point,
...
func (d *DSS) PartialSig() (*PartialSig, error) {
	...
	var err error
	ps.Signature, err = schnorr.Sign(d.suite, d.rand, d.secret, ps.Hash(d.suite))
	if !d.signed {
